module.exports = function(app) {
  ...
  //Uncomment the below code for db and tables creation
  // app.datasources.psqlDs.autoupdate(function(err) {
  //   if (err) throw err;
  //   console.log("autoupdate");
  //   /** uncomment to populate defaultTemplate data
  //   mydb.automigrate("defaultTemplate", function(err) {
  //     if (err) throw err;
  //     app.models.defaultTemplate.create([
