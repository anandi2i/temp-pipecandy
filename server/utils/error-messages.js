...
const TEMPLATE_NOT_FOUND = new Error();
TEMPLATE_NOT_FOUND.status = 404;
TEMPLATE_NOT_FOUND.name = "CAMPAIGN_TEMPLATE_NOT_FOUND";
TEMPLATE_NOT_FOUND.message = "Campaign Templates Not Found";
...
INVALID_FIELDS.status = 400;
INVALID_FIELDS.name = "INVALID_FIELDS";
...
const EMPTY_SUBJECT = new Error();
EMPTY_SUBJECT.status = 400;
EMPTY_SUBJECT.name = "EMPTY_SUBJECT";
EMPTY_SUBJECT.message = "Empty Subject!";

const EMPTY_LIST = new Error();
EMPTY_LIST.status = 400;
EMPTY_LIST.name = "EMPTY_LIST";
EMPTY_LIST.message = "Empty List!";

const BLANK_TEMPLATE_NAME = new Error();
BLANK_TEMPLATE_NAME.status = 400;
BLANK_TEMPLATE_NAME.name = "BLANK_TEMPLATE_NAME";
BLANK_TEMPLATE_NAME.message = "Template Name cannot be blank";

const BLANK_TEMPLATE_CONTENT = new Error();
BLANK_TEMPLATE_CONTENT.status = 400;
BLANK_TEMPLATE_CONTENT.name = "BLANK_TEMPLATE_CONTENT";
BLANK_TEMPLATE_CONTENT.message = "Template Content cannot be blank";

const INVALID_TEMPLATE_ID = new Error();
INVALID_TEMPLATE_ID.status = 400;
INVALID_TEMPLATE_ID.name = "INVALID_TEMPLATE_ID";
INVALID_TEMPLATE_ID.message = "Invalid Template Id";

const EMPTY_EMAIL = new Error();
EMPTY_EMAIL.status = 400;
EMPTY_EMAIL.name = "EMPTY_EMAIL";
EMPTY_EMAIL.message = "Email cannot be empty!";

const INVALID_EMAIL = new Error();
INVALID_EMAIL.status = 400;
INVALID_EMAIL.name = "INVALID_EMAIL";
INVALID_EMAIL.message = "Invalid Email id!";

const INVALID_ACCESS_TOKEN = new Error();
INVALID_ACCESS_TOKEN.status = 400;
INVALID_ACCESS_TOKEN.name = "INVALID_ACCESS_TOKEN";
INVALID_ACCESS_TOKEN.message = "Invalid Access Token!";
...
const errorMessage = {
  ...
  BLANK_TEMPLATE_NAME: BLANK_TEMPLATE_NAME,
  BLANK_TEMPLATE_CONTENT: BLANK_TEMPLATE_CONTENT,
